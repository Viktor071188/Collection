...
public class Solution {
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, Object> pair : map.entrySet()) //перебираем множество пар при помощи entrySet()
        {
            String key = pair.getKey(); // получаем  ключи
            Object value = pair.getValue(); //получаем значение
